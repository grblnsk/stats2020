...
for k=1:size(Countries,1)
    ...
    countryCasesDailyPerMillion = countryToCasesDailyPerMillionPreJSON(countryName,countryData);
    ...
    countryDeathsDailyPerMillion = countryToDeathsDailyPerMillionPreJSON(countryName,countryData);
    ...
    jsonDataStruct.data.casesDailyPerMillion.(countryName) = countryCasesDailyPerMillion.(countryName);
    ...
    jsonDataStruct.data.deathsDailyPerMillion.(countryName) = countryDeathsDailyPerMillion.(countryName);
